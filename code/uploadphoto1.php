...
$sql = mysql_query("insert into `ddubook`.`image_upload` (`iid`,`uid`,`imagep`) values (NULL,'$id','$file')");
if($sql)
{
$run = move_uploaded_file($_FILES['file']['tmp_name'],"./images/$file");
if($run)
...
"<img src='"images/".$_FILES["file"]["name"]' />"
</body>
</html>